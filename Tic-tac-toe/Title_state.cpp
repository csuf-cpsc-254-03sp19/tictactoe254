...
void Title_state::init()
{
	...
	{
		Resource_manager::load_image("title_backgroundH");
	}
	else
	{
		Resource_manager::load_image("title_backgroundA");
	}
...
void Title_state::render()
{
	...
	{
		Resource_manager::get_image("title_backgroundH")->render();
	}
	else
	{
		Resource_manager::get_image("title_backgroundA")->render();
	}
...
void Title_state::clean_up()
{
	...
	{
		Resource_manager::unload_image("title_backgroundH");
	}
	else
	{
		Resource_manager::unload_image("title_backgroundA");
	}
